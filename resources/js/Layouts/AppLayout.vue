                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6" >
                        <div class="ml-3 relative">
                            <div v-if="!$page.data.auth_check" class="flex flex-row-reverse">
                                ...
                                <button @click="register" class="mx-1 px-1 flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                    register
                                </button>
                            </div> 
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div v-else>
                    <div class="py-1 space-y-1">
                        <jet-responsive-nav-link @click.native="login" as="button" :herf="'#'">
                            login
                        </jet-responsive-nav-link>
                    </div>
                    <div class="py-1 space-y-1">
                        <jet-responsive-nav-link @click.native="register" as="button" :herf="'#'">
                            register
                        </jet-responsive-nav-link>
                    </div>
                </div>
