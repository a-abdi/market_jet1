<template>
    <app-layout>
        <div class="container mx-auto">
            <carts-link :countPrevious ="previousCart.length"/>
            <div class="grid grid-cols-4 mb-16">
                <div class="col-span-3 bg-white border border-gray-200 rounded-lg">
                    <cart-goods-info v-for="good in previousCart" :key="good.goods_code">
                        <template #image>
                        ...
                        <template #discount>
                            ...
                            <inertia-link href="/cart/change" method="patch" :data="{ good_id:good.id, current_status: 'previous_cart', next_status: 'cart'}" class="mx-2 px-2 py-1 inline-flex text-red-600 text-sm border border-gray-200 rounded-md cursor-pointer">
                        ...
                        <div class="mx-2 px-2 py-1 inline-flex text-gray-600 text-sm cursor-pointer">
                            <img src="/img/remove.png" alt="" class="w-5 h-5 mr-2"> Remove From History
                        </div>
